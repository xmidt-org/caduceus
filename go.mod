...
require (
	...
	github.com/xmidt-org/chronon v0.1.14 // indirect
	github.com/xmidt-org/urlegit v0.1.30 // indirect
	github.com/xmidt-org/webhook-schema v0.2.3 // indirect
